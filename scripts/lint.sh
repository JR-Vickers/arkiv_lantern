...
[[ -f package.json ]] || fail "No package.json found and no lint tooling is configured. Add lint tooling during Phase 1. See TEST_MATRIX.md."
...
if ! has_npm_script "lint"; then
  fail "package.json is missing scripts.lint. Configure a real lint/format check; do not make this script pass as a placeholder."
fi

run_npm_script "lint" "$package_manager"
